...
GSM8K_MIN_ACCURACY="${GSM8K_MIN_ACCURACY:-0.40}"
...
if [ "$FRAMEWORK" = "vllm" ]; then
  ...
  python3 /usr/local/bin/toy_proxy_server.py --port "$PROXY_PORT" \
...
i=0
until curl -sf "$ENDPOINT" -H 'Content-Type: application/json' \
